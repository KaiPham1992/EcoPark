...
struct LocalizableKey {
    ...
    static let switchStatusParkingOff = "switchStatusParkingOff"
    static let switchStatusParkingOn = "switchStatusParkingOn"
    ...
    static let registerYet1 = "registerYet1"
    static let registerYet2 = "registerYet2"
    static let registerYet3 = "registerYet3"
    ...
    static let next1 = "next1"
    
    static let textLoading1 = "textLoading1"
    static let textLoading2 = "textLoading2"
    static let textLoading3 = "textLoading3"
    ...
    static let checkAgain = "checkAgain"
    static let agreeCheckout = "agreeCheckout"
    static let contentCheckout = "contentCheckout"
    static let titleNeedToPay = "titleNeedToPay"
    static let titleEcoAccount = "titleEcoAccount"
    static let titleCash = "titleCash"
    static let payAndCheckout = "payAndCheckout"
    static let rating = "rating"
    static let contentRating1 = "contentRating1"
    ...
    static let questionLogout = "questionLogout"
    static let back = "back"
    static let cancelHolding = "cancelHolding"
    static let questionCancelHolding = "questionCancelHolding"
    static let renewal = "renewal"
    static let renewalContent = "renewalContent"
    static let payWallet = "payWallet"
    static let noPlace = "noPlace"
    static let noPlaceQuestion = "noPlaceQuestion"
    static let noThanks = "noThanks"
    ...
    static let usernameSignUp = "UsernameSignUp"
    static let displaynameSignUp = "DisplaynameSignUp"
    static let passwordSignUp = "PasswordSignUp"
    static let rePasswordSignUp = "RePasswordSignUp"
    static let emailSignUp = "EmailSignUp"
    static let phoneNumberSignUp = "PhoneNumberSignUp"
    ...
    //Sign Up Partner 1
    static let partnerInfo = "PartnerInfo"
    ...
    static let parkingWaitingSignUp1 = "parkingWaitingSignUp1"
    static let parkingWaitingSignUp2 = "parkingWaitingSignUp2"
    static let eco = "eco"
    ...
    static let titlePlace = "titlePlace"
    static let titlePriceOne = "titlePriceOne"
    static let titlePriceEight = "titlePriceEight"
